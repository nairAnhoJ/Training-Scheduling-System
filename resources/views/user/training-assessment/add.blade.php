                ...
                <form method="POST" action="{{ route('attendees.store') . '?key=' . $key }}">
                    ...
                    <div class="w-full mb-3">
                        ...
                        <div class="flex w-full gap-x-2">
                            ...
                            <input type="number" id="years_operating" name="years_operating" class="bg-gray-50 border border-gray-300 text-gray-600 text-sm rounded-lg block text-center w-20 px-0 py-2" autocomplete="off" value="1" readonly>
                    ...
                    <div class="flex flex-col gap-2 mt-5 md:flex-row gap-x-8">
                        ...
                        <a href="{{ route('attendees') }}" class="w-full py-2 font-bold tracking-wider text-center text-white bg-gray-500 rounded-lg hover:scale-[101%]">BACK</a>
                    </div>
                </form>
            </div>
        </div>
