...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased w-[1375px] h-[1063px] relative">
        ...
        {{-- All Text --}}
            ...
            <h2 style="font-family: 'Perpetua'" class="text-xl absolute top-[558px] left-1/4 -translate-x-1/2 text-center leading-[26px] whitespace-nowrap">has attended the Comprehensive Training on <br> Basic Safety Operators Training <span class="font-bold">{{ $attendee->brand . ' ' . $attendee->type }}</span></h2>
            <h2 style="font-family: 'Perpetua'" class="text-xl absolute top-[620px] left-1/4 -translate-x-1/2 text-center">Given on this {{ $formattedDate }}</h2>
            ...
            @if ($overallScore >= 85)
                ...
                <h2 style="font-family: 'Perpetua'" class="text-xl whitespace-nowrap absolute top-[558px] left-3/4 -translate-x-1/2 text-center leading-[26px]">has attended the Comprehensive Training on <br> Basic Safety Operators Training <span class="font-bold">{{ $attendee->brand . ' ' . $attendee->type }}</span></h2>
                <h2 style="font-family: 'Perpetua'" class="text-xl absolute top-[620px] left-3/4 -translate-x-1/2 text-center">Given on this {{ $formattedDate }}</h2>
                <h2 style="font-family: 'Perpetua'" class="text-2xl absolute font-bold top-[647px] left-3/4 -translate-x-1/2 uppercase">Class {{$class}} ({{ $overallScore }}%) Level {{$attendee->level}}</h2>
