...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased w-[1375px] h-[1063px] relative">
        ...
        {{-- All Text --}}
            ...
            <h2 style="font-family: 'Perpetua'" class="text-lg absolute top-[446px] left-1/4 -translate-x-1/2 uppercase whitespace-nowrap">{{ $training->customer->name }}</h2>
            ...
            @if ($overallScore >= 85)
                ...
                <h2 style="font-family: 'Perpetua'" class="text-lg whitespace-nowrap absolute top-[446px] left-3/4 -translate-x-1/2 uppercase">{{ $training->customer->name }}</h2>
