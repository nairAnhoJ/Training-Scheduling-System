...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased w-[1375px] h-[1063px] relative">
        ...
        {{-- All Text --}}
            ...
            <h2 style="font-family: 'Perpetua'" class="text-xl absolute italic top-[548px] left-1/4 -translate-x-1/2 text-center leading-[26px] whitespace-nowrap">has attended the Comprehensive Training on <br> Basic Safety Operators Training <span class="font-bold">{{ $attendee->brand . ' ' . $attendee->type }}</span></h2>
            <h2 style="font-family: 'Perpetua'" class="text-xl absolute italic top-[610px] left-1/4 -translate-x-1/2 text-center">Given on this {{ $formattedDate }}</h2>
            ...
            <h2 style="font-family: 'Perpetua'" class="text-sm absolute bottom-[35px] left-[35px] uppercase">{{ 'Ctrl#: TMHP-'.$cBrand.str_pad($attendee->control_number, 7, '0', STR_PAD_LEFT) }}</h2>
            ...
            @if ($overallScore >= 85)
                ...
                <h2 style="font-family: 'Perpetua'" class="text-xl italic whitespace-nowrap absolute top-[548px] left-3/4 -translate-x-1/2 text-center leading-[26px]">has attended the Comprehensive Training on <br> Basic Safety Operators Training <span class="font-bold">{{ $attendee->brand . ' ' . $attendee->type }}</span></h2>
                <h2 style="font-family: 'Perpetua'" class="text-xl absolute italic top-[610px] left-3/4 -translate-x-1/2 text-center">Given on this {{ $formattedDate }}</h2>
                ...
                <h2 style="font-family: 'Perpetua'" class="text-sm absolute bottom-[35px] left-[calc(50%+35px)] uppercase">{{ 'Ctrl#: TMHP-'.$cBrand.str_pad($attendee->control_number, 7, '0', STR_PAD_LEFT) }}</h2>
                <h2 style="font-family: 'Perpetua'" class="text-sm absolute bottom-[35px] right-[35px] uppercase">Valid Until: {{ $valid_until }}</h2>
            @endif
        {{-- All Text --}}
