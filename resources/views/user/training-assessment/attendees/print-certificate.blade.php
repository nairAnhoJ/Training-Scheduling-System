...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased w-[1375px] h-[1063px] relative">
        ...
        @endphp
        {{-- All Text --}}
            <h1 style="font-family: 'Monotype-Corsiva' !important;" class="whitespace-nowrap text-[57px] absolute top-[382px] left-1/4 -translate-x-1/2">{{ ucwords(strtolower($attendee->name)) }}</h1>
            ...
            @if ($overallScore >= 85)
                <h1 style="font-family: 'Monotype-Corsiva' !important;" class="whitespace-nowrap text-[57px] absolute top-[382px] left-3/4 -translate-x-1/2">{{ ucwords(strtolower($attendee->name)) }}</h1>
