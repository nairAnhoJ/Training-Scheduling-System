...
@section('content')
    ...
    {{-- VIEW MODAL --}}
        <div id="viewModal" class="hidden absolute top-0 left-0 w-screen h-screen bg-gray-900 z-[109] overflow-hidden flex items-center justify-center p-5">
            <div class="w-full h-full bg-white rounded-lg">
                ...
                <div class="relative h-full bg-white rounded-lg shadow">
                    ...
                    <!-- Modal body -->
                    <div class="flex h-[calc(100%-140px)] items-center justify-center p-5 overflow-x-hidden overflow-y-auto">
                        <img id="layoutURL" src="" alt="" class="responsive-height">
                    </div>
                    <!-- Modal footer -->
                    <div class="flex items-center p-4 space-x-2 border-t border-gray-200 rounded-b">
                        <button type="button" class="text-gray-500 bg-white hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-blue-300 rounded-lg border border-gray-200 text-sm font-bold md:w-24 w-1/2 py-2.5 hover:text-gray-900 focus:z-10 closeViewModal">CLOSE</button>
                    </div>
                </div>
            </div>
        </div>
                                        ...
                                        @foreach ($exams as $exam)
                                            <tr class="bg-white border-b cursor-pointer requestRow hover:bg-gray-200 even:bg-gray-100">
                                                <td class="px-6 py-4 text-center whitespace-nowrap">
                                                    <button type="button" data-url='{{ asset("storage/".$exam->layout) }}' data-name="{{ $exam->name }}" class="text-sm font-semibold text-blue-600 cursor-pointer viewButton hover:underline">View</button> |
