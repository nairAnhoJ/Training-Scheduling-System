    ...
    <div class="w-full p-5 bg-gray-200">
        <div class="min-h-[calc(100vh-96px)] p-3 bg-white rounded-lg shadow-xl">
            <div class="p-4 overflow-hidden rounded-lg">
                <form action="{{ route('survey.update') . '?id=' . $question->id }}" method="POST" class="max-w-[500px]">
                    @csrf
                    ...
                    <div class="flex flex-col gap-2 mt-5 md:flex-row gap-x-8">
                        ...
                        <a href="{{ route('survey.index') }}" class="w-full py-2 font-bold tracking-wider text-center text-white bg-gray-500 rounded-lg hover:scale-[101%]">BACK</a>
                    </div>
                </form>
            </div>
        </div>
