...
<nav class="w-screen bg-blue-500 h-14 shadow-lg">
    <div class="flex justify-between h-full">
        <div class="h-full w-14">
            <button data-drawer-target="default-sidebar" data-drawer-toggle="default-sidebar" aria-controls="default-sidebar" type="button" class="inline-flex items-center p-2 mt-2 ml-3 text-sm text-blue-600 rounded-lg bg-white hover:scale-105 shadow-xl"> 
