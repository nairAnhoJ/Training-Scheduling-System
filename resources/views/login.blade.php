                ...
                <div class="w-3/4 max-w-sm">
                    ...
                    <form method="POST" action="{{ route('login.auth') }}">
                        ...
                        <div class="relative z-0 w-full mb-6 group">
                            <input type="text" name="id_number" id="id_number" value="{{ old('id_number') }}" class="block py-2.5 px-0 w-full text-base text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-sky-600 peer" placeholder=" " required/>
